...
if (isset($_POST['save'])) {
  ...
  if ($_POST['save'] == "Save") {
    $save_sql = "INSERT INTO `customers`( `name`, `email`, `mobile`, `address`) VALUES 
          ('$name','$email','$mobile','$address')";
  }else{
    $id= $_POST['id'] ;
    $save_sql = "UPDATE `customers` SET `name`='$name',`email`='$email' ,`mobile`='$mobile' ,
...
$users_sql = "SELECT * FROM customers";
